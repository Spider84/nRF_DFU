...
#if !defined(STM32L1XX_MD) && !defined(STM32L1XX_HD) && !defined(STM32L1XX_MD_PLUS)&& !defined (USE_STM32373C_EVAL) && !defined (USE_STM32303C_EVAL) && !defined(USE_PROGRAMMATOR)
 #include "spi_if.h"
 #include "nor_if.h"
 #include "fsmc_nor.h"
